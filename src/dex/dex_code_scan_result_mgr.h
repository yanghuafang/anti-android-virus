...
class DexCodeScanResultMgr {
 public:
  ...
  DexCodeScanResultMgr(const DexCodeScanResultMgr&) = delete;
  DexCodeScanResultMgr& operator=(const DexCodeScanResultMgr&) = delete;

  int AddSigHit(DexCodeCrcSig* code_sig);
  int GetMalwareSigIds(DexSigMgr* dex_sig_mgr,
 ...
 private:
  ...
  static bool MatchNotLogic(DexCodeLogicSig& logic_sig,
                            DexCodeScanResult& scan_result);
  static bool MatchXorLogic(DexCodeLogicSig& logic_sig,
                            DexCodeScanResult& scan_result);
  static bool MatchAndLogic(DexCodeLogicSig& logic_sig,
                            DexCodeScanResult& scan_result);
  static bool MatchOrLogic(DexCodeLogicSig& logic_sig,
                           DexCodeScanResult& scan_result);
