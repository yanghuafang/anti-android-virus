...
#include "dex/dex_sig.h"           // STR_MATCH_TYPE, LOGIC_MATCH_TYPE
#include "doctest.h"
...
using aav::kStrMatchTypeContain;
using aav::kStrMatchTypeEndWith;
using aav::kStrMatchTypeEqual;
using aav::kStrMatchTypeStartWith;

static uint32_t C(const char* s) {
  return aav::Crc32(0, s, static_cast<uint32_t>(std::strlen(s)));
}
