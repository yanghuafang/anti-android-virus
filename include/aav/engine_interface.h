...
/// dereferencing it), so you can thread your own context -- a results
/// container, counters, a `this` pointer, etc. -- into the callback instead of
/// using globals. Pass nullptr if you don't need it.
///
...
/// PODs, C strings and a function pointer cross this boundary, so it is
/// ABI-stable.
